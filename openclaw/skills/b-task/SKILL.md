---
name: b-task
description: Convert a vague request, reusable prompt, or ongoing session into a Bureau task with explicit routing. Use when the user says "make this a Bureau task", "turn this prompt into a Bureau task", "formalize this session as a B-Task", or when you need to decide whether to answer directly, use one specialist, or route work across multiple workers with clear briefs, output contracts, and merge ownership.
---

> **Note:** This is the lighter-weight skill. Use for quick tasks that don't need full Bureau routing. The `project` skill is the canonical version for heavier workflows that may use more resources.
---
...
This skill is the Bureau intake and routing layer. Use it to:
